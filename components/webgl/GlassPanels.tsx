...
export default function GlassPanels() {
  return (
    <group>
      <Panel position={[-5.5, 1.5, -4]} args={[3, 1.9, 0.2]} rotation={[0.1, 0.5, -0.08]} scrollFactor={5} />
      <Panel position={[5.8, -1.5, -5]} args={[2.6, 3.4, 0.2]} rotation={[-0.05, -0.5, 0.06]} scrollFactor={7} />
