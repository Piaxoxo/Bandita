...
const BRIGHT_TOP = new THREE.Color("#FFF8F0");
const BRIGHT_BOT = new THREE.Color("#F2ECE2");
const DARK_TOP = new THREE.Color("#2A1A22");
const DARK_BOT = new THREE.Color("#130D11");
const FOG_BRIGHT = new THREE.Color("#F7EFE7");
const FOG_DARK = new THREE.Color("#1A0F15");
...
export default function SceneRoot() {
  ...
  return (
    ...
    >
      ...
      <pointLight position={[-6, -2, 2]} intensity={14} color="#FF8FB0" />
      <pointLight position={[6, 3, -2]} intensity={14} color="#FFE0CB" />
      ...
      <Blob position={[-3.4, -1.2, -2]} color="#E6D2C2" scale={1.1} speed={1.3} />
      <Blob position={[-1.6, 2.4, -3]} color="#FF9DB8" scale={0.6} speed={1.7} />
      <Blob position={[3.8, -2.4, -2.5]} color="#F0E2D4" scale={0.7} speed={1.5} />
