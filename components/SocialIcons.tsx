// Inline SVG icons for the four social channels — no icon CDNs.
// Each icon inherits `currentColor`, so the parent controls the colour/glow.
...
export const SOCIAL_ICONS: Record<string, (p: { className?: string }) => JSX.Element> = {
