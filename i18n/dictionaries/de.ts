...
const de: Dictionary = {
  ...
  about: {
    ...
    why: {
      kicker: "Warum wir?",
      heading: "Wir verkaufen kein Marketing. Wir verkaufen Vorsprung.",
      lines: [
      ...
      punchA: "Hübsch reicht nicht. Strategie verkauft.",
      punchB: "Schön ist leicht. Unvergesslich ist schwer.",
      close: "Wir verkaufen kein Marketing. Wir verkaufen Vorsprung.",
    },
    psychology: {
      ...
      detail: "Wir vermuten nicht. Wir verstehen.",
